...
class LSTM_main(nn.Module):
    ...
    def forward(self, seq_input):
        ...
        # this will output a vector of [batch_size, seq_length, 2]
        out = self.linear(out)
...
class Model(nn.Module):
    def __init__(self, inv_size, v_size, input_channels, hidden_size, output_size, batch_size, layers):
    ...
    def forward( self, raw_inv,raw_v,mask, self, seq_input):
