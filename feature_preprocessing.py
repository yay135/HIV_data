...
class DataPreprocessing:
    ...
    def read_samples(self):
        ...
        r = pd.read_csv("rfa_interval.csv") 
   ...
   def batch(self, batch_index, sample_set, testing=False):
        ...
        def encode_sample(sample):
            ...
            seq_feature = self.feature_encoder.encode(sample,self.max_seq_length)
            label_list.append(seq_feature[1])
            seq_tensors.append(seq_feature[0])
